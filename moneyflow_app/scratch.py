...
concept_url = "http://94.push2.eastmoney.com/api/qt/clist/get?cb=jQuery112404219515748621301_1656315378776&pn=1&" \
              "pz=100&po=1&np=1&ut=bd1d9ddb04089700cf9c27f6f7426281&fltt=2&invt=2&wbp2u=|0|0|0|web&fid=f3&" \
...
concept_data = {'概念名称': concept_name, '概念涨跌幅': up_down, '资金流向': representative}
print(len(concept_data['概念名称']))
